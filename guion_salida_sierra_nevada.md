...
+ Es importante que te familiarices con la ruta que seguiremos. Aunque no tiene por qué pasar nada, es buena idea saber por dónde se mueve uno en la montaña. Para ello te recomiendo dos opciones:
  + Recorre el itinerario con tu móvil para que el recorrido se vaya guardando en la caché del dispositivo. Hazlo a través de este enlace (el enlace estará disponible el lunes 23).
  + Descarga este (estará disponible el lunes 23) archivo y cárgalo en una aplicación para manejar cartografía en dispositivos móviles. Si usas Android te recomiendo que descargues [Orux Maps](https://play.google.com/store/apps/details?id=com.orux.oruxmapsDonate&gl=US). Si usas iphone, descarga Topo GPS.
